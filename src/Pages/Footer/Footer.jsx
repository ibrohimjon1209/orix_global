...
const Footer = () => {
  ...
  const t = {
    uz: {
      ...
      readyDesc: "Xorijdagi universitetlardan joyingizni naqd qilish uchun mutaxassislarimiz bilan uchrashuv belgilang.",
    ...
    ru: {
      ...
      readyDesc: "Запишитесь на консультацию к нашей команде экспертов, чтобы зарезервировать место в университете.",
    ...
    en: {
      ...
      readyDesc: "Book a consultation directly with our expert team to secure your place in a top university.",
      bookBtn: "Book Online",
    ...
    <footer className="w-full bg-[#274F94] font-sans pt-16 pb-6 text-white overflow-hidden relative border-t-[8px] border-[#8F0810]">
      ...
      <div className="max-w-[1300px] mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col gap-5 mt-0 lg:mt-0">
          ...
          <div className="flex flex-col gap-5 mt-0 sm:mt-2 lg:mt-0 bg-white/5 p-6 rounded-md border border-white/10">
            <h3 className="text-lg font-bold text-white mb-2">{t.readyTitle}</h3>
            <p className="md:block hidden text-gray-300 text-sm font-medium mb-4">{t.readyDesc}</p>
            <button
